    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="grid gap-8 row-gap-5 md:grid-cols-2">
        {chainItems
          ...
          // })
          .map((item) => {
            let isSupported = allChains.find((chainData) => chainData.id === Number(item.chain_id));
            return (
                    ...
                    <div className="flex flex-col justify-between flex-grow">
                      <div>
                        <div className="flex justify-between align-middle">
                          ...
                          {/* connected network */}
                          {isSupported && activeChain && activeChain.id === +item.chain_id && (
                            <button className="badge badge-lg border-none bg-green-100 text-green-500">
                              connected
                            </button>
                          )}
